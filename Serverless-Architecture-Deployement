...
def lambda_handler(event, context):
    ...
    Bucket: ikramkhanvideo
    Default Video: videoplayback.mp4
    API Gateway: https://ahhqj76du0.execute-api.us-east-1.amazonaws.com/default/myvideofunction
    """
    
    # Configuration
    config = {
        'S3_BUCKET': 'ikramkhanvideo',
        'DEFAULT_VIDEO': 'videoplayback.mp4',
    ...
    try:
        ...
        # Netflix-style HTML response (now Niya TV style)
        html = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
